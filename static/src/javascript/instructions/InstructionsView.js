...
class InstructionsView extends Component {
    ...
    render() {
        return (
            <Container>
                <div id="instructions">
                    <Heading.Title>Getting Started</Heading.Title>
                    <p>
                    ...
                    <Heading.Title isSize={4}>Adding Games</Heading.Title>
                    <p>
                    ...
                    <Heading.Title isSize={4}>Your profile page</Heading.Title>
                    <p>
                    ...
                    <Heading.Title isSize={4}>Managing your platforms</Heading.Title>
                    <p>
                    ...
                    <Heading.Title isSize={4}>Discovering new games</Heading.Title>
                    <p>
